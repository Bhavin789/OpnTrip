...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let APPLICATIONURL = "http://www.opntrip.com/restfulapi/request.php?authkey=VR9RP1K2VU1YZ6FQNDDGJGWQWVX3IW1X&service="
    ...
    func afterLogin(){
        if let name = UserDefaults.standard.value(forKey: "name"){
            ...
            if (username.characters.count > 0){
                ...
                let board = UIStoryboard(name: "Main", bundle: nil)
                let controller = board.instantiateViewController(withIdentifier: "vc")
                self.window?.rootViewController = controller
                self.window?.makeKeyAndVisible()
            }
        }else{
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Oinnfi")
